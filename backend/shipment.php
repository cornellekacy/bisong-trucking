                        ...
                        <div class="basic-form">
                            ...
                            <div class="basic-form">
                             ...
                             <div class="row">
                                    ...
                                    <input type="text" name="l6" value="<?php echo $data["l6"];?>" class="form-control" placeholder="" >
                                </div>
                                    </div>
                                     <div class="col-md-4">
                                             <div class="form-group">
                                   ...
                                   <div class="row">
                                    ...
                                    <input type="date" name="d8" value="<?php echo $data["d8"];?>" class="form-control" placeholder="" >
                                             ...
                                             <div class="form-group">
                                    <label><b>Description</b></label>
                                   <textarea class="form-control" rows="5" name="dc8" id="comment"><?php echo $data["dc8"];?></textarea>
