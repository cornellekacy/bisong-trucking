...
if(isset($_POST['save'])){
 ...
 $istatus = mysqli_real_escape_string($link,$_POST['istatus']);
 $pworth = mysqli_real_escape_string($link,$_POST['pworth']);
...
// Attempt insert query execution
    $sql = "INSERT INTO track (jname,jadd,jcountry,jemail,jnumber,sname,sadd,scountry,semail,snumber, prod, mode, ship_date, ddate,ship_time, dtime, currentl, pickupl, status,deliverys,cat,weight,items,packagenum,descrip,ship_id,lon,lat,istatus,pworth) 
    VALUES ('$jname','$jadd','$jcountry','$jemail','$jnumber','$sname','$sadd','$scountry','$semail','$snumber', '$prod', '$mode', '$ship_date', '$ddate','$ship_time', '$dtime', '$currentl', '$pickupl', '$status','$deliverys','$cat','$weight','$items','$me1','$descrip','$track','$lon','$lat','$istatus','$pworth')";
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label ><b>Insurance Status</b></label>

                                    <select class="form-control" name="istatus">
                                        <option value="Package Insured">Package Insured</option>
                                        <option value="Package Not Insured">Package Not Insured</option>
                                       
                                    </select>

                                </div>
                                <div class="form-group">
                                    <label><b>Package Worth</b></label>
                                    <input type="text" name="pworth" class="form-control">
                                </div>
                                <div class="form-group">
