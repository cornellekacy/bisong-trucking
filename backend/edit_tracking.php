                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Package Worth</label>
                                    <input type="text" class="form-control" name="pworth" placeholder="e.g $2000" value="<?php echo $data["pworth"];?>">
                                </div>
                                 <div class="form-group">
                                    <label>Insurance Status</label>
                                    <input type="text" class="form-control" name="istatus" placeholder="e.g $2000" value="<?php echo $data["istatus"];?>">
                                </div>
                                <div class="form-group">
