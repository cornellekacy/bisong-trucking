...
<head>
    ...
    <title>Parcel Force - Admin Panel - Login</title>
    <!-- Bootstrap Core CSS -->
...
?>
                                <p align="center"><img src="../logof.png" height="100"></p>
                                ...
                                <form method="post">
                                    ...
                                    <button type="submit" class="btn btn-primary" style="background-color: #006db7">Login</button>
